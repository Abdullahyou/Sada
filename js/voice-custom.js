! function(t) {
        ...
        ! function(e, n) {
            ...
            function x(t) {
                var e, n = t.ownerDocument,
                    i = t.nodeName,
                    o = Xt[i];
                return o || (e = n.body.appendChild(n.createElement(i)), o = yt.css(e, "display"), e.parentNode.removeChild(e), "none" === o && (o = "block"), Xt[i] = o, o)
            }

            function w(t, e) {
                for (var n, i, o = [], r = 0, s = t.length; r < s; r++) i = t[r], i.style && (n = i.style.display, e ? ("none" === n && (o[r] = Ft.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && Vt(i) && (o[r] = x(i))) : "none" !== n && (o[r] = "none", Ft.set(i, "display", n)));
            ...
            function L(t, e, n, i) {
                ...
                var o, r, a, l, u, c, f = 0,
                    ...
                    h = e[0],
                    g = yt.isFunction(h);
                if (g || p > 1 && "string" == typeof h && !mt.checkClone && re.test(h)) return t.each(function(o) {
                    var r = t.eq(o);
            ...
            function q(t, e, n) {
                ...
                return n = n || ce(t), n && (s = n.getPropertyValue(e) || n[e], "" !== s || yt.contains(t.ownerDocument, t) || (s = yt.style(t, e)), !mt.pixelMarginRight() && ue.test(s) && le.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
            }
            ...
            function B(t, e, n) {
                ...
                return ue.test(r) ? r : (i = s && (mt.boxSizingReliable() || r === t.style[e]), "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = parseFloat(r) || 0) + M(t, e, n || (s ? "border" : "content"), i, o) + "px")
            }
            ...
            function Y(t, e, n) {
                ...
                if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(d)) {
                    f && 1 === t.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], u = v && v.display, null == u && (u = Ft.get(t, "display")), c = yt.css(t, "display"), "none" === c && (u ? c = u : (w([t], !0), u = t.style.display || u, c = yt.css(t, "display"), w([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === yt.css(t, "float") && (l || (p.done(function() {
                        h.display = u
                    }), null == u && (c = h.display, u = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function() {
                        h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                    })), l = !1;
                    for (i in d) l || (v ? "hidden" in v && (g = v.hidden) : v = Ft.access(t, "fxshow", {
                        display: u
                    }), r && (v.hidden = !g), g && w([t], !0), p.done(function() {
                        g || w([t]), Ft.remove(t, "fxshow");
                        for (i in d) yt.style(t, i, d[i])
                    })), l = X(g ? v[i] : 0, i, p), i in v || (v[i] = l.start, g && (l.end = l.start, l.start = 0))
                }
            }
            ...
            function Q(t, e, n) {
                var i, o, r = 0,
                    ...
                    l = function() {
                        if (o) return !1;
                        for (var e = me || V(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(r);
                ...
                return yt.map(c, X, u), yt.isFunction(u.opts.start) && u.opts.start.call(t, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), yt.fx.timer(yt.extend(l, {
                    elem: t,
                    anim: u,
                    queue: u.opts.queue
                })), u
            ...
            var Ct =
                ...
                function(t) {
                        ...
                        if (!i && ((e ? e.ownerDocument || e : H) !== j && A(e), e = e || j, O)) {
                            ...
                            if (x.qsa && !U[t + " "] && (!L || !L.test(t))) {
                                if (1 !== h) d = e, p = t;
                                    ...
                                    for ((a = e.getAttribute("id")) ? a = a.replace(bt, xt) : e.setAttribute("id", a = F), c = E(t), r = c.length; r--;) c[r] = "#" + a + " " + f(c[r]);
                                    p = c.join(","), d = vt.test(t) && u(e.parentNode) || e
                                }
                                if (p) try {
                            ...
                            if (n = w.relative[t[a].type]) c = [p(d(c), n)];
                                ...
                                if (n = w.filter[t[a].type].apply(null, t[a].matches), n[F]) {
                                    ...
                                    return v(a > 1 && d(c), a > 1 && f(t.slice(0, a - 1).concat({
                                        value: " " === t[a - 2].type ? "*" : ""
                                    })).replace(rt, "$1"), n, a < i && m(t.slice(a, i)), i < o && m(t = t.slice(i)), i < o && f(t))
                                }
                                c.push(n)
                            }
                        return d(c)
                        ...
                        var o = n.length > 0,
                            ...
                            s = function(i, s, a, l, u) {
                                ...
                                for (u && ($ = s === j || s || u); h !== T && null != (c = b[h]); h++) {
                                    if (r && c) {
                                        for (f = 0, s || c.ownerDocument === j || (A(c), a = !O); p = t[f++];)
                                            if (p(c, s || j, a)) {
                                                l.push(c);
                                                break
                                            }
                                ...
                                if (d += h, o && h !== d) {
                                    ...
                                    Q.apply(l, m), u && !i && m.length > 0 && d + n.length > 1 && e.uniqueSort(l)
                                }
                                return u && (W = x, $ = y), v
                            };
                        return o ? i(s) : s
                    }
                    var b, x, w, T, C, E, k, S, $, D, N, A, j, I, O, L, R, q, P, F = "sizzle" + 1 * new Date,
                        H = t.document,
                        W = 0,
                        M = 0,
                        B = n(),
                    ...
                    x = e.support = {}, C = e.isXML = function(t) {
                        ...
                        return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, I = j.documentElement, O = !C(j), H !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", wt, !1) : n.attachEvent && n.attachEvent("onunload", wt)), x.attributes = o(function(t) {
                            return t.className = "i", !t.getAttribute("className")
                        }), x.getElementsByTagName = o(function(t) {
                            return t.appendChild(j.createComment("")), !t.getElementsByTagName("*").length
                        }), x.getElementsByClassName = ht.test(j.getElementsByClassName), x.getById = o(function(t) {
                            return I.appendChild(t).id = F, !j.getElementsByName || !j.getElementsByName(F).length
                            ...
                            e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && L.push("name" + tt + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && L.push(":enabled", ":disabled"), I.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && L.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), L.push(",.*:")
                        })), (x.matchesSelector = ht.test(q = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function(t) {
                            x.disconnectedMatch = q.call(t, "*"), q.call(t, "[s!='']:x"), R.push("!=", it)
                        }), L = L.length && new RegExp(L.join("|")), R = R.length && new RegExp(R.join("|")), e = ht.test(I.compareDocumentPosition), P = e || ht.test(I.contains) ? function(t, e) {
                            ...
                            return n || (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === j || t.ownerDocument === H && P(H, t) ? -1 : e === j || e.ownerDocument === H && P(H, e) ? 1 : D ? K(D, t) - K(D, e) : 0 : 4 & n ? -1 : 1)
                        } : function(t, e) {
                            if (t === e) return N = !0, 0;
                            var n, i = 0,
                                o = t.parentNode,
                        ...
                        if ((t.ownerDocument || t) !== j && A(t), n = n.replace(lt, "='$1']"), x.matchesSelector && O && !U[n + " "] && (!R || !R.test(n)) && (!L || !L.test(n))) try {
                            var i = q.call(t, n);
                        ...
                        var e, n = [],
                            i = 0,
                            o = 0;
                        if (N = !x.detectDuplicates, D = !x.sortStable && t.slice(0), t.sort(V), N) {
                                ...
                                return 1 === i && 0 === o ? function(t) {
                                    ...
                                    if (v) {
                                        ...
                                        if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                            for (p = v, f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), u = c[t] || [], d = u[0] === W && u[1], b = d && u[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (b = d = 0) || h.pop();)
                                                if (1 === p.nodeType && ++b && p === e) {
                                                    c[t] = [W, d, b];
                                                    break
                                                }
                                        } else if (y && (p = e, f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), u = c[t] || [], d = u[0] === W && u[1], b = d), !1 === b)
                                            for (;
                                                (p = ++d && p && p[g] || (b = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++b || (y && (f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[t] = [W, b]), p !== e)););
                    ...
                    return c.prototype = w.filters = w.pseudos, w.setFilters = new c, E = e.tokenize = function(t, n) {
                        ...
                        var n, i = [],
                            ...
                            r = U[t + " "];
                        if (!r) {
                            for (e || (e = E(t)), n = e.length; n--;) r = m(e[n]), r[F] ? i.push(r) : o.push(r);
                        ...
                        if (n = n || [], 1 === p.length) {
                            if (r = p[0] = p[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && 9 === e.nodeType && O && w.relative[r[1].type]) {
                            ...
                            for (o = ft.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !w.relative[a = s.type]);)
                                if ((l = w.find[a]) && (i = l(s.matches[0].replace(mt, yt), vt.test(r[0].type) && u(e.parentNode) || e))) {
                                    if (r.splice(o, 1), !(t = i.length && f(r))) return Q.apply(n, i), n;
                                    break
                                }
                        }
                        return (c || k(t, p))(i, e, !O, n, !e || vt.test(t) && u(e.parentNode) || e), n
                    }, x.sortStable = F.split("").sort(V).join("") === F, x.detectDuplicates = !!N, A(), x.sortDetached = o(function(t) {
            ...
            yt.event = {
                ...
                add: function(t, e, n, i, o) {
                    var r, s, a, l, u, c, f, p, d, h, g, v = Ft.get(t);
                    if (v)
                        for (n.handler && (r = n, n = r.handler, o = r.selector), o && yt.find.matchesSelector(Zt, o), n.guid || (n.guid = yt.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function(e) {
                                return void 0 !== yt && yt.event.triggered !== e.type ? yt.event.dispatch.apply(t, arguments) : void 0
                            }), e = (e || "").match(Ot) || [""], u = e.length; u--;) a = ne.exec(e[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = yt.event.special[d] || {}, d = (o ? f.delegateType : f.bindType) || d, f = yt.event.special[d] || {}, c = yt.extend({
                            type: d,
                            origType: g,
                            data: i,
                            handler: n,
                ...
                remove: function(t, e, n, i, o) {
                    var r, s, a, l, u, c, f, p, d, h, g, v = Ft.hasData(t) && Ft.get(t);
                    if (v && (l = v.events)) {
                        for (e = (e || "").match(Ot) || [""], u = e.length; u--;)
                            if (a = ne.exec(e[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                                ...
                                s && !p.length && (f.teardown && !1 !== f.teardown.call(t, h, v.handle) || yt.removeEvent(t, d, v.handle), delete l[d])
                            } else
            ...
            yt.extend({
                ...
                style: function(t, e, n, i) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        ...
                        r = typeof n, "string" === r && (o = _t.exec(n)) && o[1] && (n = b(t, e, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (yt.cssNumber[a] ? "" : "px")), mt.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (u[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? u.setProperty(e, n) : u[e] = n))
                    }
                },
                css: function(t, e, n, i) {
                    var o, r, s, a = yt.camelCase(e);
                    return pe.test(e) || (e = H(a)), s = yt.cssHooks[e] || yt.cssHooks[a], s && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = q(t, e, i)), "normal" === o && e in he && (o = he[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
                }
            }), yt.each(["height", "width"], function(t, e) {
                yt.cssHooks[e] = {
                    get: function(t, n, i) {
                        if (n) return !fe.test(yt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? B(t, e, i) : zt(t, de, function() {
                            return B(t, e, i)
                        })
                    },
                    set: function(t, n, i) {
                        ...
                        return s && (o = _t.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = yt.css(t, e)), W(t, n, s)
                    }
                }
            }), yt.cssHooks.marginLeft = P(mt.reliableMarginLeft, function(t, e) {
                if (e) return (parseFloat(q(t, "marginLeft")) || t.getBoundingClientRect().left - zt(t, {
                    marginLeft: 0
                }, function() {
            ...
            yt.extend(yt.event, {
                trigger: function(t, e, i, o) {
                    ...
                    if (s = a = i = i || st, 3 !== i.nodeType && 8 !== i.nodeType && !Se.test(d + yt.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, t = t[yt.expando] ? t : new yt.Event(d, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), e = null == e ? [t] : yt.makeArray(e, [t]), f = yt.event.special[d] || {}, o || !f.trigger || !1 !== f.trigger.apply(i, e))) {
                        ...
                        for (r = 0;
                            (s = p[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : f.bindType || d, c = (Ft.get(s, "events") || {})[t.type] && Ft.get(s, "handle"), c && c.apply(s, e), (c = u && s[u]) && c.apply && Pt(s) && (t.result = c.apply(s, e), !1 === t.result && t.preventDefault());
            ...
            yt.param = function(t, e) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var t = this.type;
                        return this.name && !yt(this).is(":disabled") && Oe.test(this.nodeName) && !Ie.test(t) && (this.checked || !Yt.test(t))
                    }).map(function(t, e) {
                        var n = yt(this).val();
            ...
            Ue.href = $e.href, yt.extend({
                ...
                ajax: function(t, e) {
                    function i(t, e, i, a) {
                        var u, p, d, x, w, T = e;
                        c || (c = !0, l && n.clearTimeout(l), o = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, u = t >= 200 && t < 300 || 304 === t, i && (x = it(h, C, i)), x = ot(h, x, C, u), u ? (h.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (yt.lastModified[r] = w), (w = C.getResponseHeader("etag")) && (yt.etag[r] = w)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, p = x.data, d = x.error, u = !d)) : (d = T, !t && T || (T = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (e || T) + "", u ? m.resolveWith(g, [p, T, C]) : m.rejectWith(g, [C, T, d]), C.statusCode(b), b = void 0, f && v.trigger(u ? "ajaxSuccess" : "ajaxError", [C, h, u ? p : d]), y.fireWith(g, [C, T]), f && (v.trigger("ajaxComplete", [C, h]), --yt.active || yt.event.trigger("ajaxStop")))
                    }
                    ...
                    if (m.promise(C), h.url = ((t || h.url || $e.href) + "").replace(We, $e.protocol + "//"), h.type = e.method || e.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ot) || [""], null == h.crossDomain) {
            ...
            var Ve = {
                ...
                ze = yt.ajaxSettings.xhr();
            mt.cors = !!ze && "withCredentials" in ze, mt.ajax = ze = !!ze, yt.ajaxTransport(function(t) {
                var e, i;
                if (mt.cors || ze && !t.crossDomain) return {
                    send: function(o, r) {
                        var s, a = t.xhr();
                        ...
                        e = function(t) {
                            return function() {
                                e && (e = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Ve[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                    binary: a.response
                                } : {
                                    text: a.responseText
            ...
            yt.ajaxSetup({
                ...
                if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = yt.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Ye, "$1" + o) : !1 !== t.jsonp && (t.url += (Ne.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
                    return s || yt.error(o + " was not called"), s[0]
                }, t.dataTypes[0] = "json", r = n[o], n[o] = function() {
                    s = arguments
                }, i.always(function() {
                    void 0 === r ? yt(n).removeProp(o) : n[o] = r, t[o] && (t.jsonpCallback = e.jsonpCallback, Xe.push(o)), s && yt.isFunction(r) && r(s[0]), s = r = void 0
                }), "script"
                ...
                var i, o, r;
                return e || (mt.createHTMLDocument ? (e = st.implementation.createHTMLDocument(""), i = e.createElement("base"), i.href = st.location.href, e.head.appendChild(i)) : e = st), o = $t.exec(t), r = !n && [], o ? [e.createElement(o[1])] : (o = E([t], e, r), r && r.length && yt(r).remove(), yt.merge([], o.childNodes))
    ...
    "EW+R": function(t, e, n) {
        (function(t) {
            n("jf49"),
                function(t) {
                    if (t("ul.nav li.dropdown").hover(function() {
                            ...
                            t(".navbar-nav li a").bind("click", function(e) {
                                var n = t(this);
                                t(n.attr("href")).length && (t("html, body").stop().animate({
                                    scrollTop: t(n.attr("href")).offset().top
                                }, 1500, "easeInOutExpo"), e.preventDefault())
                            }), t("a.totop,a#btn-scroll,a.btn-slide,.carousel-inner .item a.btn").bind("click", function(e) {
                                var n = t(this);
                                t("html, body").stop().animate({
                                    scrollTop: t(n.attr("href")).offset().top
                                }, 1500, "easeInOutExpo"), e.preventDefault()
                            }), t("#sounds_list").length && t("html, body").stop().animate({
                                scrollTop: t("#sounds_list").offset().top
                            }, 1500)
                        }), t("#voice").length) {
                        var e = function(t) {
                                var e = parseFloat(l.value),
                                    n = parseFloat(u.value),
                                    i = parseFloat(c.value);
                                if (a.value) var o = responsiveVoice.getVoices().filter(function(t) {
                                    return t.name == a.value
                                })[0];
                                responsiveVoice.speak(t, o.name, {
                                    pitch: i,
                                    rate: n,
                                    volume: e
                                })
                            ...
                            n = t("#msg");
                        responsiveVoice.voiceSupport() ? n.html("Your browser <strong>supports</strong> speech synthesis.") : n.html("Your browser <strong>does not support</strong> speech synthesis.");
                        var i = document.getElementById("btnSpeak"),
                            o = document.getElementById("btnPause"),
                            r = document.getElementById("btnResume"),
                            s = document.getElementById("speech-msg"),
                            a = document.getElementById("voice"),
                            l = document.getElementById("volume"),
                            u = document.getElementById("rate"),
                            c = document.getElementById("pitch");
                        ! function() {
                            if (!t("#voice option").length) {
                                responsiveVoice.getVoices().forEach(function(t, e) {
                                    var n = document.createElement("option");
                                    n.value = t.name, n.innerHTML = t.name, "undefined" != typeof defaultLanguage && defaultLanguage == t.name && (n.selected = !0), a.appendChild(n)
                                })
                            }
                        }(), i.addEventListener("click", function(t) {
                            t.preventDefault(), s.value.length > 0 && e(s.value)
                        }), o.addEventListener("click", function(t) {
                            t.preventDefault(), responsiveVoice.isPlaying() && responsiveVoice.pause()
                        }), r.addEventListener("click", function(t) {
                            t.preventDefault(), responsiveVoice.resume()
                        })
                    }
                    t(".btn-play-mp3").click(function(e) {
                        e.preventDefault(), t(this).siblings("audio").trigger("play")
                    }), t(".btn-save-mp3").click(function(e) {
                        e.preventDefault(), window.open(t(this).data("sound"), "_blank")
                    })
                }(t)
        }).call(e, n("7t+N"))
    },
